...
def build_baseline(
    ...
    # /checkpoint/pfz/projects/distseal/baselines-watermarking/readme.md
    if os.path.exists('/checkpoint/pfz/projects/distseal/baselines-watermarking'):
        base_path = '/checkpoint/pfz/projects/distseal/baselines-watermarking'
    else:
