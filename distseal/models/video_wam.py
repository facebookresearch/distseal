...
class VideoWam(Wam):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            latent_layer_watermarker_input=latent_layer_watermarker_input,
            latent_layer_normalization=latent_layer_normalization,
        )
        # video settings
    ...
    def forward(
        ...
        if not is_video:
            ...
            return super().forward(imgs, masks, msgs, is_detection_loss=is_detection_loss)
