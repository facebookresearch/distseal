...
from deps.efficientvit.models.nn.triton_rms_norm import TritonRMSNorm2dFunc
from deps.efficientvit.models.utils import build_kwargs_from_config
...
def reset_bn(
    ...
    from deps.efficientvit.apps.utils import AverageMeter, is_master, sync_tensor
    from deps.efficientvit.models.utils import get_device, list_join
